...
from funcktions import print_slow, time, Config, ctext, reset_text_color
...
def update_teams():
    ...
    global team1, team2
    alive_team_2 = [char2 for char2 in team2 if char2.hp > 0]
    alive_team_1 = [char1 for char1 in team1 if char1.hp > 0]
...
team1 = create_team([Player])
team2 = create_team([Skeleton, Skeleton, Skeleton, Skeleton])
game()
